                            ...
                            pendingPayments.map(payment => (
                                <div key={payment.id} className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-[#333] p-6 rounded-xl border border-[#444]">
                                    <div className="flex flex-col">
                                        ...
                                        <span className="text-sm text-[#a0a0a0]">{payment.despesaNome}</span>
                                        <span className="font-bold text-xl text-[#FFD600] mt-1">
                                            R$ {(payment.valor || 0).toLocaleString('pt-BR', { minimumFractionDigits: 2 })}
                                        </span>
                                    </div>
                                    <div className="flex gap-2 flex-wrap">
                                        ...
                                        <button className="grow md:grow-0 bg-[#a03c3c] text-white px-4 py-2.5 rounded-lg font-semibold text-sm cursor-pointer hover:bg-[#c04a4a] transition-colors">
                                            Rejeitar
                                        </button>
                                        <button className="grow md:grow-0 bg-[#3c8a5a] text-white px-4 py-2.5 rounded-lg font-semibold text-sm cursor-pointer hover:bg-[#4ba86e] transition-colors">
                                            Aprovar
                                        </button>
                                    </div>
                                </div>
